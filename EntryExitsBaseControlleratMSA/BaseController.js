	...
	{		
		...
		{		
			...
			return new Promise((reject,resolve)=>{reject(postgresConnection);});
		}
		else 
		{
			return new Promise((reject,resolve)=>{resolve(postgresConnection);});
		}
	}
	...
	{		
		...
		let h3 = time3 / 3600; let min3 = (time3 % 3600)/60;let sec3 = (time3 % 3600)%60
		return h3+":"+min3+":"+sec3;
	}
