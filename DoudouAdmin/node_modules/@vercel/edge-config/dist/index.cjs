...
async function getFileSystemEdgeConfig(connection) {
  ...
  if (!process.env.AWS_LAMBDA_FUNCTION_NAME)
    return null;
  try {
    const content = await _edgeconfigfs.readFile.call(void 0, 
...
exports.createClient = createClient; exports.digest = digest; exports.get = get; exports.getAll = getAll; exports.has = has; exports.parseConnectionString = parseConnectionString;
