...
function store_values_Box_Pos_Only(element)
{
	return mFirstOccurenceGetBetweenElements(["-----Box:","Pos:","-----"],element);
	//console.log(returnValue);
}
...
module.exports = {store_values,store_values_global,store_values_Box_Pos_Only,SplitLongString};